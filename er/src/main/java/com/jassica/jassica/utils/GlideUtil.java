...
public class GlideUtil {
    ...
    //加载资源图片
    public static void loadImageDefaultPlaceHolder( Object image, ImageView iv, Context context){
        RequestOptions options = new RequestOptions()
    ...
    //加载资源图片
    public static void loadImage(Drawable placeholderImg, Object image, ImageView iv, Context context){
        RequestOptions options = new RequestOptions()
                .placeholder(placeholderImg);
        Glide.with(context)
                .load(image)
     ...
     * @param imageView
     */
    public static void loadCacheImg(Context context, int placeholder, Object object, ImageView imageView){
        RequestOptions requestOptions = new RequestOptions()
                .placeholder(placeholder)
                .skipMemoryCache(false)
                .diskCacheStrategy(DiskCacheStrategy.ALL);//做缓存
        Glide.with(context)
                .load(object)
                .apply(requestOptions)
                .into(imageView);
