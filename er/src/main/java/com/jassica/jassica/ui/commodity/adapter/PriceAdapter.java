...
public class PriceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<PriceBean.DatasBean.GoodsListBean> list;

    public PriceAdapter(Context context, List<PriceBean.DatasBean.GoodsListBean> list) {
        this.context = context;
        this.list = list;
    }

    public void addData(List<PriceBean.DatasBean.GoodsListBean> lists){
        if (lists!=null){
            list.clear();
            list.addAll(lists);
        }
