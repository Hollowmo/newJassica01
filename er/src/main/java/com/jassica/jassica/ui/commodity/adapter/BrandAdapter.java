...
public class BrandAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ScreenBean.DatasBean.BrandMapBean> mBrandMapBeans;

    public BrandAdapter(Context context, List<ScreenBean.DatasBean.BrandMapBean> brandMapBeans) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        //获取数据
        String hotName = mBrandMapBeans.get(i).getBrandName();
        //绑定数据
