...
public class HotAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<NewHotBean.DatasBean.GoodsListBean> list;

    public HotAdapter(Context context, List<NewHotBean.DatasBean.GoodsListBean> list) {
        this.context = context;
        this.list = list;
    }

    public void addData(List<NewHotBean.DatasBean.GoodsListBean> lists) {
        if (lists != null) {
            list.clear();
            list.addAll(lists);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        GlideUtil.loadImageDefaultPlaceHolder(list.get(i).getImageSrc(), hotHolder.hotImg, context);
    ...
    static class HotHolder extends RecyclerView.ViewHolder {
        ...
        HotHolder(@io.reactivex.annotations.NonNull View itemView) {
            super(itemView);
